...
## Data Source
The dataset deployed for the purpose of this analysis was provided via a secondary data source on Kaggle.com. It contained 5 sheets, 34 columns.[Dataset]()

## Data Processing & Analysis
I deployed Python Jupiter Notebook, pandas, numpy and matplotlib libraries to track KPI metrics amongst essential data fields, such as product type, channel,  unit price and region.
